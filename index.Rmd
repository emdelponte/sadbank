...
There are two pages, on for the [Plots](#summary-plots) (right panel on this page) and [Tables](#tables) that summarize characteristics of the peer-reviewd publication and the SADs. There are three tables with tabuluar information for the 1) publication; 2) SAD characteristics and 3) the validation approach. A weblink allows direct access to the publication.

<b class=rev>What are SADs?</b>

SADs are a set of pictorial representation  of disease symptoms and/or signs in a plant organ. Each diagram depicts a percent diseased area. They are designed in a wide range of styles. 
...
g_soft <- ggplot(dat_sad1, aes(sev_quant2)) +
            geom_bar(fill = "#21908d") + coord_flip()+
...
geom_point(aes(alpha=0.5), size=3, colour = "#21908d",
            position = position_jitter(width=.2))+
 stat_smooth(colour="#21908d", size=0.75, alpha=0.1)+
  theme_minimal()+
 theme(legend.position = "none")+
