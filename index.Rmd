...
table1 <- select(dat_sad2, pub_year, crop, pathogen, pathogen_group, journal, country, lang, pub_type, citation)
...
datatable(table1,
          ...
          rownames = FALSE, colnames = c('Publication year','Crop', 'Pathogen', 'Pathogen group', 'Journal', 'Country', 'Language', 'Publication type',  'Reference'), 
          options = list(
  pageLength = 25,
  fontSize = 12,
...
formatStyle(
  c('crop', 'pathogen', 'pathogen_group', 'pub_year','journal', 'country', 'lang', 'pub_type', 'citation'),
  fontSize = '90%')
...
library(dplyr)
dat_sad2 <- ungroup(dat_sad1)
table1 <- select(dat_sad2, pub_year, crop, dis_name, pathogen,  organ, col_type, n_diagrams, min_sev, max_sev, citation)
...
datatable(table1, 
          class = 'cell-border stripe',
        rownames = FALSE, colnames = c('Publication year','Crop', 'Disease name', 'Pathogen', 'Organ',  'Diagram color', 'N. of diagrams', 'Min. Severity', 'Max. Severity', 'Reference'), 
          options = list(
  pageLength = 25,
  fontSize = 12,
  lengthMenu = c(10, 25, 50, 100 )
