...
**SAD<i class="fa fa-leaf" aria-hidden="true"></i>Bank** is a database of Standard Area Diagrams (SADs) of plant disease severity. The database supplements a research article to be submitted to *Plant Pathology* and will be updated as more SADs are published in the literature. 
