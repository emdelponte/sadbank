...
Total number of SADs **`r nrow(table1)`**. Apply the filters to reorder or use enter any word on the search box. The link icon will direct you to the publisher website to get the full article.
